...
- Portefeuille réel (14 positions) :
  ETF: PAEEM (13 titres, PRU 30.91€), PTPXE (3, PRU 34.46€), DCAM (80, PRU 5.51€), ESE (10, PRU 29.86€)
  BPF actions: RMS/Hermès (1, PRU 2037€), AI/Air Liquide (10, PRU 159€), LR/Legrand (5, PRU 139€),
  HO/Thales (3, PRU 237€), SU/Schneider (7, PRU 241€), TTE/TotalEnergies (20, PRU 50€),
  EL/EssilorLuxottica (3, PRU 212€), GTT (4, PRU 197€), ELIS (45, PRU 19€), ASML (1, PRU 654€)
- IMPORTANT : Hermès (RMS) coûte ~1700€ par titre — impossible d'en acheter avec 400€.
  Pour les recommandations d'achat, respecter TOUJOURS les prix réels :
  si budget < prix d'1 action, proposer un ETF ou une autre action accessible
...
[Une seule décision concrète. Budget habituel = 1000€/mois.
RÈGLE ABSOLUE : ne jamais recommander d'acheter une action dont le prix dépasse le budget alloué.
Hermès = ~1700€/titre donc inaccessible avec 400€ → proposer renforcer ETF DCAM à la place.
Exemple correct : "Avec 1000€ : 600€ sur DCAM (ETF monde, 110 titres), 300€ sur Legrand (2 titres à 146€), 100€ en attente."
Toujours mentionner le nombre de titres possibles ET le prix actuel approximatif.]
